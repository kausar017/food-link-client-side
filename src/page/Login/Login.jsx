    ...
    return (
        <div className="min-h-screen" style={{
            ...
            <div className="py-[150px] container mx-auto md:flex justify-around items-center max-sm:px-2">
                ...
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl border-2 backdrop-blur-xl  dark:bg-gray-50 text-white dark:text-gray-800">
                    ...
                    <form onSubmit={handaleSIngIn} action="" className="space-y-6">
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="email" name="email" id="username" placeholder="Email" className="w-full px-4 py-3 rounded-md border-gray-700 dark:border-gray-300 bg-gray-500/20 dark:bg-gray-50 text-white dark:text-gray-800 focus:border-rose-400 focus:dark:border-rose-600" />
                        </div>
                        <div className="space-y-1 text-sm">
                            <label htmlFor="password" className="block text-gray-400 dark:text-gray-600">Password</label>
                            <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border-gray-700 dark:border-gray-300 bg-gray-500/20 dark:bg-gray-50 text-white dark:text-gray-800 focus:border-rose-400 focus:dark:border-rose-600" />
                    ...
                    <p className="text-sm text-center sm:px-6 text-gray-400 dark:text-gray-600 ">Don't have an account?
                        <Link to={'/singup'} rel="noopener noreferrer" className="underline text-white dark:text-gray-800">Sign up</Link>
                    </p>
                </div>
            </div>
