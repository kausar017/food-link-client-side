            ...
            <section className="flex items-center h-screen p-16 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                    <div className="max-w-md text-center">
                        ...
                        <Link to={'/'} rel="noopener noreferrer" href="#" className="px-8 py-3 font-semibold rounded bg-rose-400 dark:bg-rose-600 text-gray-900 dark:text-gray-50">Back to homepage</Link>
                    </div>
                </div>
            </section>
        </div>
